...
tools.onStylesReady = () => {
    ...
    let elem6Animation = document.querySelector("[data-animation-element='bolo']");
    ...
    setTimeout(function(){
        ...
        TweenMax.to(elem1Animation, .8, { bottom:-250, ease: "sine.in", delay:2.2});
        TweenMax.to(elem2Animation, .8, { top:25, ease: "sine.in", delay:2.4});
        TweenMax.to(elem3Animation, .8, { top:15, ease: "sine.in", delay:2.5});
        TweenMax.to(elem4Animation, .8, { top:15, ease: "sine.in", delay:.8});
        TweenMax.from(elem5Animation, .8, { css: { rotation: 180 , opacity:0 ,scaleX:1.2, scaleY:1.2  } , delay:3});
        TweenMax.to(elem5Animation, .8, { css: { opacity:1   } , delay:3});
        TweenMax.to(elem6Animation, .8, { css: { scaleX:1, scaleY:1, opacity:1 }, ease:Bounce.easeOut, delay:3.4});
